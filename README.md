...
- [closing-evidence-atlas](https://github.com/Moranetz/closing-evidence-atlas) — Pre-registered systematic review and Bayesian meta-analysis of 39 named sales-closing techniques. 11,785 records screened across 7 public databases. 572 included after Stage-1. **15 techniques classified as empirical deserts** — zero peer-reviewed studies despite high practitioner prominence. PRISMA 2020 conformant. **First per-technique posteriors are public:** gain-framing μ=0.501, 95% CrI [0.251, 0.733] (k=6); loss-framing μ=0.343, 95% CrI [0.237, 0.448] (k=5). Both clear the d=0.2 practical-significance threshold with P>0.98.
